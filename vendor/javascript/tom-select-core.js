import MicroEvent from "tom-select-microevent";
import MicroPlugin from "tom-select-microplugin";
import { Sifter } from '@orchidjs/sifter';
import { escape_regex } from '@orchidjs/unicode-variants';
import { highlight, removeHighlight } from "tom-select-highlight";
import * as constants from "tom-select-constants";
import getSettings from "tom-select-get-settings";
import { hash_key, get_hash, escape_html, debounce_events, getSelection, preventDefault, addEvent, loadDebounce, timeout, isKeyDown, getId, addSlashes, append, iterate } from "tom-select-utils";
import { getDom, isHtmlString, escapeQuery, triggerEvent, applyCSS, addClasses, removeClasses, parentMatch, getTail, isEmptyObject, nodeIndex, setAttr, replaceNode } from "tom-select-vanilla";
var instance_i = 0;
